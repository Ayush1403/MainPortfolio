    ...
    return (
        <section id='HeroDiv' className='relative w-full min-h-screen'>
            <div id='ContentDiv' className='absolute flex w-full h-full '>
                <div id='HeadingDiv' className='top-0 absolute w-full -space-y-4 lg:-space-y-11 lg:w-1/2 flex  flex-col z-50  text-white m-20 text-[2rem]  md:text-[4rem] lg:text-[4.2rem] p-4 font-bold font-poppins'>
